...
import { Menu, Home, Upload, Users, Scale } from "lucide-react"
          ...
          <div className="hidden md:flex">
            <Button
              ...
              className="bg-purple-600 text-white font-medium rounded-lg px-6 py-2.5
                         hover:bg-purple-500 hover:shadow-md hover:scale-[1.02]
                         transition-all"
            >
              <Link href="/document-upload">Try Analysis</Link>
            </Button>
          </div>
            ...
            <Sheet>
              ...
              >
                ...
                <div className="mt-auto border-t border-gray-800 p-4">
                  <Button
                    asChild
                    className="w-full bg-purple-600 text-white font-medium rounded-lg px-6 py-2.5
                               hover:bg-purple-500 hover:shadow-md hover:scale-[1.02]
                               transition-all"
                  >
                    <Link href="/document-upload">Try Analysis</Link>
